...
bool dk_sdd_inference::on_init(){
    logger::info("<{}> call dk_sdd_inference on_init", _THIS_COMPONENT_);
...
void dk_sdd_inference::on_loop(){
    logger::info("<{}> call dk_sdd_inference on_loop", _THIS_COMPONENT_);
...
void dk_sdd_inference::on_close(){
    logger::info("<{}> call dk_sdd_inference on_close", _THIS_COMPONENT_);
}

void dk_sdd_inference::on_message(){
    logger::info("<{}> call dk_sdd_inference on_message", _THIS_COMPONENT_);
}
